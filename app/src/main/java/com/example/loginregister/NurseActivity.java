    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(NurseActivity.this, Manifest.permission.CALL_PHONE) ==
                        PackageManager.PERMISSION_GRANTED)
                    call();
                else
                    ActivityCompat.requestPermissions(NurseActivity.this, new String[]{Manifest.permission.CALL_PHONE}, 100);
            }
        });
        ...
        mMessage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(NurseActivity.this, Manifest.permission.SEND_SMS) ==
                        PackageManager.PERMISSION_GRANTED)
                    sendMessage();
                else
                    ActivityCompat.requestPermissions(NurseActivity.this, new String[]{Manifest.permission.SEND_SMS}, 100);
            }
        });
    }
